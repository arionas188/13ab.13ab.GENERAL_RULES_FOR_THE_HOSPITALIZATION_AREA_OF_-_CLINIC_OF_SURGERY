    ...
    function changeLanguage(lang) {
        let content = {
            "gr": {
                ...
                "section": "📌 ΤΟΜΕΑΣ ΚΛΙΝΙΚΩΝ ΚΤΗΝΙΑΤΡΙΚΩΝ ΣΠΟΥΔΩΝ ΧΕΙΡΟΥΡΓΙΚΗ ΚΛΙΝΙΚΗ",
                ...
                "cautionParagraph": "Διατηρείτε το χώρο του νοσηλευτηρίου και τον εξοπλισμό πάντα καθαρά."

            },
            "en": {
                "title": "FACULTY OF VETERINARY MEDICINΕ",
                "section": "📌 FDEPARTMENT OF CLINICAL VETERINARY STUDIES CLINIC OF SURGERY",
